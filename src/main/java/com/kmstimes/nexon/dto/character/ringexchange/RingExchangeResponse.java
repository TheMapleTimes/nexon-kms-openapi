 ...
 * @param special_ring_exchange_icon        링 익스체인지에 등록된 특수 반지 아이콘
 * @param special_ring_exchange_description 링 익스체인지에 등록된 특수 반지 설명
 */
public record RingExchangeResponse(
        ...
        String special_ring_exchange_icon,
        String special_ring_exchange_description
) {
}
