...
import com.kmstimes.nexon.dto.character.equipment.item.option.ItemAddOption;
import com.kmstimes.nexon.dto.character.equipment.item.option.ItemBaseOption;
import com.kmstimes.nexon.dto.character.equipment.item.option.ItemEtcOption;
import com.kmstimes.nexon.dto.character.equipment.item.option.ItemExceptionalOption;
import com.kmstimes.nexon.dto.character.equipment.item.option.ItemTotalOption;

/**
 * 메이플스토리 장비 정보를 담는 데이터 클래스입니다.
 *
 ...
 * @param potential_option_flag             잠재능력 봉인 여부 (true 봉인, false 봉인 없음)
 * @param additional_potential_option_flag  에디셔널 잠재능력 봉인 여부 (true 봉인, false 봉인 없음)
 * @param potential_option_grade            잠재능력 등급
 * @param additional_potential_option_grade 에디셔널 잠재능력 등급
 * @param potential_option_1                잠재능력 첫 번째 옵션
 * @param potential_option_2                잠재능력 두 번째 옵션
 * @param potential_option_3                잠재능력 세 번째 옵션
 * @param additional_potential_option_1     에디셔널 잠재능력 첫 번째 옵션
 * @param additional_potential_option_2     에디셔널 잠재능력 두 번째 옵션
 * @param additional_potential_option_3     에디셔널 잠재능력 세 번째 옵션
...
public record ItemEquipment(
        ...
        String date_expire,
        String potential_option_flag,
        String additional_potential_option_flag,
