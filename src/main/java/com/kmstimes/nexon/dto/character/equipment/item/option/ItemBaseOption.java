package com.kmstimes.nexon.dto.character.equipment.item.option;

import com.google.gson.annotations.SerializedName;

/**
 * 메이플스토리 장비 기본 옵션 정보를 담는 데이터 클래스입니다.
 *
 * @param str                  STR
 * @param dex                  DEX
 * @param inte                 INT
 ...
 * @param base_equipment_level 기본 착용 레벨
 */
