...
import com.kmstimes.nexon.dto.probability.potential.common.PotentialOption;

import java.util.List;

/**
 * 메이플스토리 잠재능력 재설정 이용 결과 정보를 담는 데이터 클래스입니다.
 *
 * @param potential_type                     대상 잠재능력 타입 (잠재능력, 에디셔널 잠재능력)
 * @param id                                 잠재능력 재설정 히스토리 식별자
 * @param character_name                     캐릭터 명
 * @param date_create                        사용 일시 (KST) (example: 2024-01-25T17:28:31.000+09:00)
 * @param item_upgrade_result                사용 결과
 * @param miracle_time_flag                  미라클 타임 적용 여부
 * @param item_equipment_part                장비 분류
 * @param item_level                         장비 레벨
 * @param target_item                        잠재능력 재설정 장비 명
