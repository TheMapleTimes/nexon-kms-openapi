...
import com.kmstimes.nexon.api.GuildApi;
import com.kmstimes.nexon.error.handler.NexonApiExceptionHandler;
import com.kmstimes.nexon.model.guild.GuildBasicResponse;
import com.kmstimes.nexon.model.guild.GuildIdResponse;
 ...
 * <p>
 * {@link GuildApi} 인터페이스를 기반으로, 실제 API 요청을 수행하고,
 * 예외 처리를 일관되게 처리합니다.
 * <p>
...
public class GuildApiClient {
    ...
    /**
     * 생성자: Retrofit 인스턴스를 주입받아 {@link GuildApi} 를 초기화합니다.
     *
     * @param retrofit Retrofit 인스턴스
     */
    public GuildApiClient(Retrofit retrofit) {
        this.guildApi = retrofit.create(GuildApi.class);
    }
     ...
     */
    public GuildIdResponse getGuildId(String guildName, String worldName) {
     ...
     */
    public GuildBasicResponse getGuildBasic(String guildId, LocalDate date) {
