...
import com.kmstimes.nexon.api.json.NoticeApiJson;
 ...
 * <p>
 * {@link NoticeApiJson} 인터페이스를 기반으로, 실제 API 요청을 수행하고,
 * 예외 처리를 일관되게 처리합니다.
 * <p>
 ...
 * </ul>
 */
public class NoticeApiJsonClient {
    private final NoticeApiJson noticeApi;

    /**
     * 생성자: Retrofit 인스턴스를 주입받아 {@link NoticeApiJson} 를 초기화합니다.
     *
     * @param retrofit Retrofit 인스턴스
     */
    public NoticeApiJsonClient(Retrofit retrofit) {
        this.noticeApi = retrofit.create(NoticeApiJson.class);
    }
     ...
     */
    public ResponseBody getNotices() {
     ...
     */
    public ResponseBody getNoticeDetail(Long noticeId) {
        validateId(noticeId);
     ...
     */
    public ResponseBody getUpdateNotices() {
        return NexonApiExceptionHandler.execute(() ->
     ...
     */
    public ResponseBody getUpdateNoticeDetail(Long noticeId) {
        validateId(noticeId);
     ...
     */
    public ResponseBody getEventNotices() {
        return NexonApiExceptionHandler.execute(() ->
     ...
     */
    public ResponseBody getEventNoticeDetail(Long noticeId) {
        validateId(noticeId);
     ...
     */
    public ResponseBody getCashshopNotices() {
        return NexonApiExceptionHandler.execute(() ->
     ...
     */
    public ResponseBody getCashshopNoticeDetail(Long noticeId) {
        validateId(noticeId);
