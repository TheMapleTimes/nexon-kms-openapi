...
class CharacterApiJsonClientTest {
    ...
    void getCharacterAchievement() {
        ...
        ResponseBody res = api
                .CharacterJson()
                .getCharacterAchievement(apiKey);
        resPrint(res);
    }
    ...
    void getCharacterSkill() {
        ...
        for (SkillGrade grade : SkillGrade.values()) {
            ResponseBody res = api
                    .CharacterJson()
                    .getCharacterSkill(ocid, date, grade.getGrade());
            resPrint(res);
        }
    }
    ...
    void getCharacterOtherStat() {
        ...
        ResponseBody res = api
                .CharacterJson()
                .getCharacterOtherStat(ocid, date);
        resPrint(res);
    }
    ...
    void getCharacterRingExchange() {
        ...
        ResponseBody res = api
                .CharacterJson()
                .getCharacterRingExchange(ocid, date);
        resPrint(res);
    }
    
    @Test
    void getCharacterRingReserve() {
